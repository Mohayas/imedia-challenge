...
class Mapper {
    ...
    fun productToProductDto(product: Product): ProductDto {
        ...
        val productDto = ProductDto(product.id, product.title, product.subTitle, product.description, product.price)
    ...
    fun ratingToRatingDto(rating: Rating): RatingDto {
        ...
        return RatingDto(rating.id, rating.comment, rating.title, rating.numberOfStars, rating.product.id)
    }
    ...
    fun ratingDtoToRating(ratingDto: RatingDto): Rating {
        ...
        return Rating(ratingDto.id, ratingDto.comment, ratingDto.title, ratingDto.numberOfStars, product)
    }
}